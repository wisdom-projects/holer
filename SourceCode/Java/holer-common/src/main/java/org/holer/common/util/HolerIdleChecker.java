...
*/
public class HolerIdleChecker extends IdleStateHandler
{
    private static Logger log = LoggerFactory.getLogger(HolerIdleChecker.class);

    public HolerIdleChecker(int readerIdleTime, int writerIdleTime, int allIdleTime)
    {
